...
Drop table if exists tab_devol_reparable;
...
(
        ...
        ind_tema BOOLEAN NOT NULL DEFAULT TRUE, -- Preferencia de tema: TRUE=Claro, FALSE=Oscuro
        ind_idioma VARCHAR(5) NOT NULL DEFAULT 'ES', -- Preferencia de idioma: ES=Español, EN=Inglés
        -- Audit Trail
...
(
        ...
        fecha_cambio TIMESTAMP WITHOUT TIME ZONE NOT NULL DEFAULT NOW(), -- Fecha y hora en que se registró el cambio de precio
...
-- Tabla de devoluciones pendientes (esperando revisión: Reparado o Desechado)
Create table tab_devol_reparable
(
        id_devol_reparable INT, -- Identificador único
